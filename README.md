...
Installation (ETHOS)
    ...
    Download the latest release (recommended) or clone this repository.

    Copy the GIB2A folder to your radio SD card so you end up with:

    SCRIPTS/WIDGETS/GIB2A/main.lua

    Reboot the radio.

    Add the widget on a screen (Model → Display → Widgets) and select GIB2A.
